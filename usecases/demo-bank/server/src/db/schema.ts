import { authorizationErrorInfoSchema } from "demo-bank-shared/types/vidos-errors";
...
// Type-safe metadata schemas are defined in demo-bank-shared/api/callback.ts
