...
const mcpServerUrl =
	import.meta.env.VITE_MCP_WINE_AGENT_URL ?? "http://localhost:30123/mcp";
			...
			<div className="space-y-12">
				<header className="space-y-4">
					...
					<p className="max-w-2xl text-lg leading-relaxed text-muted-foreground">
						We host the MCP server — you just need to register it as an app in
						ChatGPT. Once connected, you can browse wines and complete an
						age-verified checkout directly from the chat.
					</p>
				</header>
				...
				<section className="space-y-4">
					...
					<div className="rounded-2xl border border-border/60 bg-card p-5">
						<ol className="space-y-3">
							...
							<StepItem number={4}>
								Once selected, ChatGPT can use the wine store tools exposed by
								the MCP server.
							</StepItem>
						</ol>
					</div>
				...
				<section className="space-y-4">
					<div>
						...
						<p className="text-sm text-muted-foreground">
							A conversational shopping flow where ChatGPT uses MCP tools and
							the UI handles the age-verification handoff.
						</p>
					</div>
